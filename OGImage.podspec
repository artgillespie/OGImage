#
# Be sure to run `pod spec lint OGImage.podspec' to ensure this is a
# valid spec.
#
...
Pod::Spec.new do |s|
  ...
  # s.description  = <<-DESC
  #                   An optional longer description of OGImage
  #
  #                   * Markdown format.
  ...
  # s.authors      = { "Art Gillespie" => "art@tapsquare.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Art Gillespie', 'other author'

  # Specify the location from where the source should be retrieved.
  #
  s.source       = { :git => "http://github.com/origamilabs/OGImage.git", :tag => "0.0.1" }
  # s.source       = { :svn => 'http://EXAMPLE/OGImage/tags/1.0.0' }
  # s.source       = { :hg  => 'http://EXAMPLE/OGImage', :revision => '1.0.0' }
